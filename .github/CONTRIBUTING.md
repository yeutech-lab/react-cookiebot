# Contributing to `react-cookiebot`

Love react-cookiebot and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/react-cookiebot/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/react-cookiebot.git
   # Navigate to the newly cloned directory
   cd react-cookiebot
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/react-cookiebot.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/yeutech-lab/react-cookiebot/blob/master/LICENSE.md).
